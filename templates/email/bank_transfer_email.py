translations = {
    'pt': {
        'greeting': 'Olá {}',
        'line_1': 'De modo a finalizar a sua compra, por favor faça uma transferência bancária utilizando '
    ...
    'en-US': {
        'greeting': 'Hello {}',
        'line_1': 'In order to complete your order, please make a bank transfer using the details below:',
        'amount': 'Amount:',
                                ...
                                <tr>
                                    <td style="font-family: sans-serif; font-size: 14px; vertical-align: top;">
                                        ...
                                        <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; Margin-bottom: 15px;">
                                            <b>IBAN:</b> {iban} </p>
                                        <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; Margin-bottom: 15px;">
                                            <b>{amount}</b> {amount_value} {currency}</p>
                                        <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; Margin-bottom: 15px;">
                                           {line_2} </p>
                                                        ...
                                                        <tr>
                                                            <td style="font-family: sans-serif; font-size: 14px; vertical-align: top; background-color: #3498db; border-radius: 5px; text-align: center;">
                                                                <a href="{order_url}" target="_blank"
                                                                   style="display: inline-block; color: #ffffff; background-color: #72d48b; border: solid 1px #72d48b; border-radius: 5px; box-sizing: border-box; cursor: pointer; text-decoration: none; font-size: 14px; font-weight: bold; margin: 0; padding: 12px 25px; text-transform: capitalize; border-color: #72d48b;">
                                                                    {button_label}</a></td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0"
                        ...
                        <tr>
                            <td class="content-block"
                                ...
                                <a href="https://mangalibe.com"
                                                                 style="text-decoration: none; color: #999999; font-size: 12px; text-align: center;">Mangalibe</a>
                            </td>
                        </tr>
                        <tr>
