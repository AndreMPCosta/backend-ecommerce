                                                ...
                                                <tr>
                                                    <td role="modules-container"
                                                        ...
                                                        <table border="0" cellpadding="0" cellspacing="0" align="center"
                                                               ...
                                                               style="padding:30px 20px 30px 20px;" bgcolor="#f6f6f6">
                                                            <tbody>
                                                                                    ...
                                                                                    <tr>
                                                                                        <td style="font-size:6px; line-height:10px; padding:0px 0px 0px 0px;"
                                                                                            ...
                                                                                            <img class="max-width"
                                                                                                 ...
                                                                                                 src="https://backend.mangalibe.com/static/assets/logo2.png"
                                                                                                 >
                                                                                        </td>
                                                                                    </tr>
                                                                                    </tbody>
                                                                                        ...
                                                                                        <td style="padding:50px 30px 18px 30px; line-height:36px; text-align:inherit; background-color:#ffffff;"
                                                                                            ...
                                                                                            <div>
                                                                                                <div style="font-family: inherit; text-align: center">
                                                                                                    <span style="font-size: 43px">Obrigado por se registar, {name}!&nbsp;</span>
                                                                                                </div>
                                                                                                <div></div>
                                                                                            </div>
                                                                                        </td>
                                                                                ...
                                                                                <table class="module" role="module"
                                                                                    ...
                                                                                    <tr>
                                                                                        <td style="padding:18px 30px 18px 30px; line-height:22px; text-align:inherit; background-color:#ffffff;"
                                                                                            ...
                                                                                            <div>
                                                                                                <div style="font-family: inherit; text-align: center">
                                                                                                    <span style="font-size: 18px">Por favor verifique o seu endereço de email</span><span
                                                                                                        style="color: #000000; font-size: 18px; font-family: arial,helvetica,sans-serif"> para que possa utilizar a nossa loja</span><span
                                                                                                        style="font-size: 18px">.</span>
                                                                                                </div>
                                                                                                <div style="font-family: inherit; text-align: center">
                                                                                                    <span style="color: #ffbe00; font-size: 18px"><strong>Obrigado!&nbsp;</strong></span>
                                                                                                </div>
                                                                                                <div></div>
                                                                                            </div>
                                                                                        </td>
                                                                                                ...
                                                                                                <tr>
                                                                                                    <td align="center"
                                                                                                        ...
                                                                                                        <a href="{to_frontend_link}"
                                                                                                           ...
                                                                                                           target="_blank">Verificar Email</a>
                                                                                                    </td>
                                                                                                </tr>
                                                                                                </tbody>
                                                                                            </table>
                                                                                ...
                                                                                <table class="module" role="module"
                                                                                    ...
                                                                                    <tr>
                                                                                        <td style="padding:50px 30px 18px 30px; line-height:36px; text-align:inherit; background-color:#ffffff;"
                                                                                            ...
                                                                                            <div>
                                                                                                <div style="font-family: inherit; text-align: center">
                                                                                                    <span style="font-size: 43px">Thanks for signing up, {name}!&nbsp;</span>
                                                                                                </div>
                                                                                                <div></div>
                                                                                            </div>
                                                                                        </td>
                                                                                ...
                                                                                <table class="module" role="module"
                                                                                    ...
                                                                                    <tr>
                                                                                        <td style="padding:18px 30px 18px 30px; line-height:22px; text-align:inherit; background-color:#ffffff;"
                                                                                            ...
                                                                                            <div>
                                                                                                <div style="font-family: inherit; text-align: center">
                                                                                                    <span style="font-size: 18px">Please verify your email address</span><span
                                                                                                        style="color: #000000; font-size: 18px; font-family: arial,helvetica,sans-serif"> to get access to our store</span><span
                                                                                                        style="font-size: 18px">.</span>
                                                                                                </div>
                                                                                                <div style="font-family: inherit; text-align: center">
                                                                                                    <span style="color: #ffbe00; font-size: 18px"><strong>Thank you!&nbsp;</strong></span>
                                                                                                </div>
                                                                                                <div></div>
                                                                                            </div>
                                                                                        </td>
